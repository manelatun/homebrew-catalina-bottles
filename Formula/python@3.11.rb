# SHA256:VErbWfX5M2BC7oQKh62TfFbrHFtVPnt5fHipIKqfX2g=
...
class PythonAT311 < Formula
  ...
  bottle do
    ...
    rebuild 1
    sha256 catalina: "216cd8255c9b31463a073236cdc55e2e8e8a9dc13f5dde7bfe2855efa0bc55c5"
  end
  ...
  depends_on "manelatun/catalina-bottles/mpdecimal"
  depends_on "manelatun/catalina-bottles/openssl@3"
  depends_on "manelatun/catalina-bottles/sqlite"
  ...
  on_linux do
    depends_on "manelatun/catalina-bottles/berkeley-db@5"
    depends_on "manelatun/catalina-bottles/libnsl"
  end
