# SHA256:ol+/oJ3LeSLUw1+MiLBXS2gxOvY3rWiXMZY1l34j8h8=
...
class Gcc < Formula
  ...
  bottle do
    ...
    rebuild 3
    sha256 catalina: "163a9b6c6b66d6ecbf7db310e2e7cdbc070d58d4d6f6c4dde1ac097bc63e9241"
  end
  ...
  depends_on "manelatun/catalina-bottles/isl"
  depends_on "manelatun/catalina-bottles/libmpc"
  ...
  on_linux do
    depends_on "manelatun/catalina-bottles/binutils"
  end
