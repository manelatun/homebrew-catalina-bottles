# SHA256:s3mMExEj8XEL+lzDmxUPavUDgKtXw4lDvrWuohJ34D0=
...
class Libxcb < Formula
  ...
  bottle do
    ...
    rebuild 1
    sha256 cellar: :any, catalina: "69b3e9314dabb6a501c56ed0d2d374ac0d69f4f697c073a08cb632fb4e92991e"
  end

  depends_on "manelatun/catalina-bottles/pkg-config" => :build
  depends_on "manelatun/catalina-bottles/python@3.12" => :build # match version in `xcb-proto`
  depends_on "manelatun/catalina-bottles/xcb-proto" => :build
  depends_on "manelatun/catalina-bottles/libxau"
  depends_on "manelatun/catalina-bottles/libxdmcp"
