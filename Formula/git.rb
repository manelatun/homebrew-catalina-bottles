# SHA256:Yefz9fQzVEMYBvZruVAxyy/9NTq1Fq9in15V115IFpw=
...
class Git < Formula
  ...
  bottle do
    root_url "https://github.com/manelatun/homebrew-catalina-bottles/releases/download/tgrq703l/"
    rebuild 1
    sha256 catalina: "7c1fe84d0b5a950da8fad44045d0b87500b08a78aa3febf9db1c151a80af7fb9"
  end
  ...
  on_linux do
    depends_on "manelatun/catalina-bottles/linux-headers@5.15" => :build
    depends_on "manelatun/catalina-bottles/openssl@3" # Uses CommonCrypto on macOS
  end
