# SHA256:bm7yP5cj+cDnE3MeuRAISVBGMkk3tV6rjcNGEfnwX5s=
...
class Ruby < Formula
  ...
  bottle do
    ...
    rebuild 1
    sha256 catalina: "55d94ed3f2e4288eb83bc342e7d938ff1d8360a37250bdd6a96e0c5f0ef31217"
  end
  ...
  depends_on "manelatun/catalina-bottles/rust" => :build
  depends_on "manelatun/catalina-bottles/libyaml"
