# SHA256:qoZkVRlzZjCmYWUe9UK6IHTnWrqkgS+81R1zOoM8lXk=
...
class Glib < Formula
  ...
  bottle do
    ...
    rebuild 1
    sha256 catalina: "ca8f2ac8686c63a8403a70a6cb8e57943a5cb1aa65a7fb7db0f83cd4df22a862"
  end
  ...
  on_linux do
    depends_on "manelatun/catalina-bottles/dbus"
