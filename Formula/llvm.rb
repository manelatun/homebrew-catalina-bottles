# SHA256:q6iThZRVAjAj13Zly1Mn+NlwEzCXKlTkpNl9qCOVN9U=
...
class Llvm < Formula
  ...
  bottle do
    ...
    rebuild 1
    sha256 cellar: :any, catalina: "d141cba965aa772b883054ecce9fd66f42f6a3f0f70c2fb43ae82b83f6933ceb"
  end
  ...
  depends_on "manelatun/catalina-bottles/swig" => :build
  depends_on "manelatun/catalina-bottles/python@3.12"
  depends_on "manelatun/catalina-bottles/z3"
  depends_on "manelatun/catalina-bottles/zstd"
  ...
  on_linux do
    ...
    depends_on "manelatun/catalina-bottles/binutils" # needed for gold
    depends_on "manelatun/catalina-bottles/elfutils" # openmp requires <gelf.h>
  end
