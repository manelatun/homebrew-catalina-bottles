# SHA256:nlud9Oi90w+PXLYiBgkUptbk7dV8CnynwwwDjpr6+iw=
...
class Meson < Formula
  ...
  bottle do
    ...
    rebuild 1
    sha256 cellar: :any_skip_relocation, catalina: "a705ee7075c443b94bbe935d9a2723e089cb38ac4ddd561e84938e07bb29d202"
  end

  depends_on "manelatun/catalina-bottles/python-setuptools" => :build
  depends_on "manelatun/catalina-bottles/ninja"
